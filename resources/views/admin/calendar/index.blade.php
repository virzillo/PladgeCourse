...
@endpush
   ...
   <div class="row">
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Trascina il corso nel calendario</h4>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div id="calendar-events" class="m-t-20 m-b-20">
                                            ...
                                            <div class="calendar-events" data-class="bg-info"><i class="fa fa-circle text-info"></i> {{$course->nome}}</div>
                                            @endforeach
                                        </div>
                                        <!-- checkbox -->
                                        <div class="checkbox">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#add-new-event" class="btn btn-sm m-t-40 btn-danger btn-block waves-effect waves-light">
...
!function($) {
    ...
    CalendarApp.prototype.init = function() {
        ...
        var defaultEvents =  [{
                ...
                className: 'bg-info',resourceIds: ['a', 'b'],
            },{
                ...
                className: 'bg-purple',resourceIds: ['a', 'b'],
            },{
                title: 'your meeting with john',
            ...
            },  
              {
                ...
                className: 'bg-success',resourceIds: ['a', 'b'],
            }];
