...
{{-- <div class="modal fade" id="editCourse" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="row">
    ...
    {{--<div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <button class="pull-right btn btn-sm btn-rounded btn-success" data-toggle="modal"
                    data-target="#addModules">Aggiungi esame</button>
                    ...
                    <table class="table stylish-table">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    <h6>{{$module->nome}}</h6><small class="text-muted">{{$module->durata}} :
                                        ORE</small>
                                </td>
                                ...
                                <td>
                                    <div class="button-group" style="display:flex;">
                                        <a href="{{route('courses.edit',$module->id)}}"
                                            class="btn btn-sm waves-effect waves-light btn-outline-info">Edit</a>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('modules.store') }}" method="POST">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Esame</label>
                                <input type="text" class="form-control" name="esame">
                            </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Chiudi</button>
